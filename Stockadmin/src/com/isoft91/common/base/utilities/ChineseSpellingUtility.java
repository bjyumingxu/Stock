 ...
 * @ClassName:ChineseSpelling.java
 * @Description: 获取中文的全拼及首拼工具类
 * @Copyright: Copyright (c) 2016
 * @Company:天津市融创软通科技有限公司
 * @author: Lan Yuan
 * @email: lanyuan@91isoft.com 
 * @date 2016年2月20日 下午11:35:55
 * @version V1.0
 */
public class ChineseSpellingUtility implements BaseCommonUtility{
	
	  Logger logger  =  Logger.getLogger(ChineseSpellingUtility.class);
	  ...
	  public static void main(String[] args) throws ParseException {
		  System.out.println(getSpell("天津融创软通", true));
		  System.out.println(getSpell("天津融创软通", false));
	  }
}